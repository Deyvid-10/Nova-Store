...
export default function DetailProductPage(){
  ...
  return <DetailProduct idItem={idItem}/>
}
...
//   queryFn: () => fetchOneProduct({ idItem }),
...
//                           defaultChecked={item.color === data.option[0].color}
//                           name="color"
//                           type="radio"
//                           onChange={handleColor}
//                           className={
                             
//                             `${item.style} size-8 cursor-pointer appearance-none rounded-full forced-color-adjust-none checked:outline-2 checked:outline-offset-2 focus-visible:outline-3 focus-visible:outline-offset-3`
//                           }
//                         />
//                       </div>
//                     ))}
...
//                             defaultChecked={item.size === data.option[0].size}
//                             name="size"
//                             type="radio"
