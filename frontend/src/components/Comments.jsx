        ...
        <>
            <form className='flex flex-col gap-3'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <select defaultValue={"4"} className="rounded-md w-14 bg-white px-3 py-1.5 hover:cursor-pointer text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600">
                ...
                <button className="mb-10 mt-1 w-36 rounded-md border border-transparent bg-indigo-600 px-4 py-1 text-base font-medium text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden"
                >Post comment</button>
            </form>
            ...
            <div key={index} className='border-b mt-3 border-gray-200 pb-5'>
                <div className='flex items-center gap-2'>
                    ...
                    <h6 className='font-semibold text-gray-950'>{comment.user_name}</h6>
                ...
                <div dangerouslySetInnerHTML={{__html: comment.comment}} className='mt-2 ml-1 text-gray-800'>
